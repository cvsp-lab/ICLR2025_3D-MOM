...
class Options():
    ...
    def __init__(self) -> None:
        ...
        self.parser.add_argument("--encoder_ckpt",  type=str, default="./thirdparty/StyleCineGAN/ckpts", help="Feature-Style encoder chekpoint directory")
        self.parser.add_argument("--sg2_ckpt",      type=str, default="./thirdparty/StyleCineGAN/ckpts/stylegan2-pytorch/sg2-lhq-1024.pt", help="stylegan2 generator checkpoint directory")
        self.parser.add_argument("--datasetgan_dir", type=str, default="./thirdparty/StyleCineGAN/ckpts/datasetGAN", help="datasetGAN checkpoint directory")
        self.parser.add_argument("--eulerian_dir", type=str, default="./thirdparty/StyleCineGAN/ckpts/epoch-20-feature_encoder.pth", help="eulerian feature encoder directory")
        self.parser.add_argument("--flownet_dir",   type=str, default="./thirdparty/StyleCineGAN/ckpts", help="flownet checkpoint directory")
        ...
        self.parser.add_argument("--ir_se50", type=str, default="./thirdparty/StyleCineGAN/ckpts/model_ir_se50.pth")
        self.parser.add_argument("--moco", type=str, default='./thirdparty/StyleCineGAN/ckpts/moco_v2_800ep_pretrain.pt')
        ...
        self.parser.add_argument('--input_dir', type=str, help='input folder that contains src images', required=True)
        self.parser.add_argument('--train_iteration', type=int, default=200)
