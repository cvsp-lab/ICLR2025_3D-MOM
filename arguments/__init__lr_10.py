...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.position_lr_final = 0.0000016/10
        print("self.position_lr_final:",self.position_lr_final)
        print("orignal position_lr_final: 0.0000016")
        self.position_lr_delay_mult = 0.01
        self.position_lr_max_steps = 20_000
        self.deformation_lr_init = 0.00016
        self.deformation_lr_final = 0.000016/10
        self.deformation_lr_delay_mult = 0.01
        self.grid_lr_init = 0.0016
        self.grid_lr_final = 0.00016/10
